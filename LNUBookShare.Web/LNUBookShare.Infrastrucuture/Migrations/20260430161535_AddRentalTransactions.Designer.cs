...
namespace LNUBookShare.Infrastructure.Migrations
{
    ...
    [Migration("20260430161535_AddRentalTransactions")]
    partial class AddRentalTransactions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LNUBookShare.Domain.Entities.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BookId = 1,
                            CreatedAt = new DateTime(2024, 4, 12, 10, 0, 0, 0, DateTimeKind.Utc),
                            IsRead = false,
            ...
            modelBuilder.Entity("LNUBookShare.Domain.Entities.RentalTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("rental_transaction_pkey");
                    ...
                    b.ToTable("rental_transaction", (string)null);
                });
            ...
            modelBuilder.Entity("LNUBookShare.Domain.Entities.RentalTransaction", b =>
                {
                    ...
                    b.HasOne("LNUBookShare.Domain.Entities.User", "Borrower")
                        .WithMany()
            ...
            modelBuilder.Entity("UserReport", b =>
                {
                    b.HasOne("LNUBookShare.Domain.Entities.User", "ReportedUser")
                        .WithMany()
